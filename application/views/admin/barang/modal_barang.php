...
<link href="<?php echo base_url()?>assets/js/bootstrap-datetimepicker.css" rel="stylesheet" media="screen">
<!-- CREATE -->
...
foreach ($barang -> result_array () as $i) :
    ...
    $foto = $i ['foto'];
    ?>
<div class="modal fade" id="editbarang<?php echo $id; ?>" role="dialog">
	<div class="modal-dialog">
			...
			<div class="modal-body">
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> Barang's Name </label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="i_nama" placeholder=""
								value=" <?php echo $nama ; ?> ">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> Barang's Merk </label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="i_merek" placeholder=""
				...
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> Barang's Type </label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="i_tipe" placeholder=""
								value="<?php echo $tipe ; ?> ">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> barang's Price </label>
						<div class="col-sm-10">
							<input type="number" class="form-control" name="i_harga" placeholder=""
				...
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> Barang's Stock </label>
						<div class="col-sm-10">
							<input type="number" class="form-control" name="i_jumlah" placeholder=""
...
foreach ($barang -> result_array () as $i) :
    ...
    ?>
<div class="modal fade" id="pinjambarang<?php echo $id; ?>" role="dialog">
	<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<div class="row">
						<label for="title" class="col-sm-2 control-label"> Barang's Price </label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="i_harga" placeholder=""
...
<div class="modal fade" id="deletebarang<?php echo $id; ?>" role="dialog">
	<div class="modal-dialog">
		<form class="form-horizontal" action="<?php echo base_url('index.php/admin/barang/delete/' .$id); ?>"
			method="post">
			<div class="modal-content">
				<div class="modal-header">
